 ...
 */
final class Version20210623165610 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE passe CHANGE note note DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE passe CHANGE note note DOUBLE PRECISION DEFAULT NULL');
    }
}
