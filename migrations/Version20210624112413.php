 ...
 */
final class Version20210624112413 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE passe (id INT AUTO_INCREMENT NOT NULL, epreuve_id INT DEFAULT NULL, eleve_id INT DEFAULT NULL, note DOUBLE PRECISION NOT NULL, INDEX IDX_D317EE5FAB990336 (epreuve_id), INDEX IDX_D317EE5FA6CC7B2 (eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
