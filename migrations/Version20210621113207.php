 ...
 */
final class Version20210621113207 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE epreuve ADD utilisateurs_id INT DEFAULT NULL, CHANGE duree duree INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE epreuve_utilisateur (epreuve_id INT NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_B928A63FFB88E14F (utilisateur_id), INDEX IDX_B928A63FAB990336 (epreuve_id), PRIMARY KEY(epreuve_id, utilisateur_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE epreuve DROP utilisateurs_id, CHANGE duree duree DATETIME NOT NULL');
    }
}
